    ...
    >
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.detalleContainer}>
          ...
          {/* Botón WhatsApp */}
          <TouchableOpacity 
            onPress={() => enviarWhatsApp(publicacion.telefono, `Hola ${publicacion.nombre_vendedor}, estoy interesado en tu artículo: ${publicacion.nombre_articulo}, ¿aun sigue disponible?`)}
