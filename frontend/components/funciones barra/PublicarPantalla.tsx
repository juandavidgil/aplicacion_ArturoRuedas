...
const PublicarPantalla: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  const componentesPorBici: Record<string, { label: string; value: string }[]> = {
   MTB: [
    ...
    { label: 'Ruedas', value: 'ruedaMtb' },
    { label: 'Manubrio', value: 'manubrio' },
    { label: 'Suspensión Delantera', value: 'tenedorMtb' },
    { label: 'Suspensión Trasera', value: 'amortiguadortraseroMtb' },
    { label: 'Pedales', value: 'pedales' },
    { label: 'Bielas', value: 'bielaMtb' },
    { label: 'Sillín', value: 'sillin' },
    { label: 'Frenos', value: 'frenosdiscoMtb' },
    { label: 'Cadena', value: 'cadena' },
    { label: 'Platos', value: 'bielaMtb' },
    { label: 'Piñón', value: 'pinonMtb' },
    { label: 'Desviador Trasero', value: 'desviadortraseroMtb' },
    { label: 'Mando de Cambio', value: 'mandodecambio' },
    // Componentes comunes adicionales
    { label: 'Caña', value: 'cana' },
    { label: 'Centro', value: 'centro' },
    { label: 'Juego de Dirección', value: 'juegodedireccion' },
    { label: 'Poste', value: 'poste' },
    { label: 'Neumático', value: 'neumatico' }
  ],
  Ruta: [
    { label: 'Marco', value: 'marcoRuta' },
    { label: 'Ruedas', value: 'ruedaRuta' },
    { label: 'Manubrio', value: 'manubrio' },
    { label: 'Horquilla', value: 'tenedorRuta' },
    { label: 'Pedales', value: 'pedales' },
    { label: 'Piñones / Cassette', value: 'pinonRuta' },
    { label: 'Cadena', value: 'cadena' },
    { label: 'Plato', value: 'bielaRuta' },
    { label: 'Sillín', value: 'sillin' },
    { label: 'Frenos', value: 'frenospinsaRuta' },
    { label: 'Desviador Delantero', value: 'desviadordelanteroRuta' },
    { label: 'Desviador Trasero', value: 'desviadortraseroRuta' },
    { label: 'Cambios', value: 'cambiosRuta' },
    // Componentes comunes adicionales
    { label: 'Caña', value: 'cana' },
    { label: 'Centro', value: 'centro' },
    { label: 'Juego de Dirección', value: 'juegodedireccion' },
  ...
  Fija: [
    ...
    { label: 'Ruedas', value: 'ruedaFixie' },
    { label: 'Manubrio', value: 'manubrio' },
    { label: 'Piñón', value: 'pinonFixie' },
    { label: 'Pedales', value: 'pedales' },
    { label: 'Cadena', value: 'cadena' },
    { label: 'Plato', value: 'bielasFixie' },
    { label: 'Sillín', value: 'sillin' },
    { label: 'Tenedor / Horquilla', value: 'tenedorFixie' },
    { label: 'Bielas', value: 'bielasFixie' },
    // Componentes comunes adicionales
    { label: 'Caña', value: 'cana' },
    { label: 'Centro', value: 'centro' },
    { label: 'Juego de Dirección', value: 'juegodedireccion' },
